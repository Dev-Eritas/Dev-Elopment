  ...
  <div class="site-wrap">
   ...
   <!--CIUDADES SLIDES-->
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/Beni.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              ...
              <div class="unit-1-text">
                <h3 class="unit-1-heading">Ecoturismo en Bolivia!</h3>
              </div>
            </a>
          </div>
        </div>
...
<!--DESTINOS POPULARES PARA QUE ESCOJA EL USUARIO-->
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2 class="font-weight-light text-black">DESTINOS MÁS POPULARES</h2>
            <p class="color-black-opacity-5">Elige tus proximas vacaciones</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="hoteles.html" class="unit-1 text-center">
              ...
              <div class="unit-1-text">
                ...
                <h3 class="unit-1-heading">Salar de Uyuni</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="hoteles.html" class="unit-1 text-center">
              ...
              <div class="unit-1-text">
                ...
                <h3 class="unit-1-heading">Isla del Sol</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="hoteles.html" class="unit-1 text-center">
              ...
              <div class="unit-1-text">
                <strong class="text-primary mb-2 d-block">$390</strong>
                <h3 class="unit-1-heading">Parque nacional Madidi</h3>
              </div>
            </a>
          </div>
        </div>
    ...
    <!-- <div class="site-section bg-light">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <video width="900" height="507" src="videos/spot.mp4" controls></video>
        </div>
      </div>
    ...
    <div class="site-section border-top">
      <div class="container">
        <div class="row text-center">
          <div class="col-md-12">
            <h2 class="mb-5 text-black">Quieres conocer Bolivia?</h2>
            <p class="mb-0"><a href="sobreBolivia.html" class="btn btn-primary py-3 px-5 text-white">Hazlo ahora!</a></p>
          </div>
        </div>
      </div>
    </div>
