...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center" data-aos="fade-up">
            <div class="col-md-7">
              <h1 class="font-weight-light text-black text-center">Hotel Tambo Coquesa Lodge:</h1>
            </div>
          </div>
    </div>
  </div>
  <div class="container text-center">
      <div class="row">
          <div class="col-md-6">
                <h4 >Tambo Coquesa Lodge ubicado a 1 horas 30 minutos desde
                    Uyuni en 4x4 atravesando el salar , en el lugar estratégico
                    más impresionante del mundo, a las orilla del Salar mas grande
                    del mundo y a los pies del imponente "Volcán Thunupa", situado
                    a 3.600 m.s.n.m. perdido entre piedras volcánicas.
                    Cabañas construidas de sal y paja brava, pensado para grupos que
                    quieran pasar una noche única e inolvidable con la construcción
                    mas rara del mundo exclusivamente de sal.
                      </h4>
          </div>
          <div class="col-md-6">
          ...
          <div id="mycarousel" class="carousel slide" data-ride="carousel" data-interval="4000" >
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="img/hotelTamboCoquesa/image1.jpg" width="1000" height="640" controls>
                <div class="carousel-caption"></div>
              </div>
              <div class="carousel-item">
                <img src="img/hotelTamboCoquesa/image2.jpg" width="1000" height="640"  controls>
                <div class="carousel-caption"></div>
              </div>
              <div class="carousel-item">
                <img src="img/hotelTamboCoquesa/image3.jpg" width="1000" height="640" controls>
                <div class="carousel-caption"></div>
              </div>
              <div class="carousel-item">
                <img src="img/hotelTamboCoquesa/image4.jpg" width="1000" height="640" controls>
                <div class="carousel-caption"></div>
              </div>
            </div>
