...
@section('title', 'Ecoturismo')

@section('content')

    <div class="site-blocks-cover inner-page-cover" style="background-image: url(images/Tarija.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">

            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h1 class="text-white font-weight-light">ECOTURISMO</h1>
              <div><a href="/welcome">Home</a> <span class="mx-2 text-white">&bullet;</span> <span class="text-white">Ecoturismo</span></div>
